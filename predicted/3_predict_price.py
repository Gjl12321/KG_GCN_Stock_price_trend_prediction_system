...
if __name__ == '__main__':
    file_dir = 'log/' + str(time.strftime("%Y%m%d", time.localtime()))
    ...
    relate_list = stock_dict[params['stock']]
    ...
    train_data, test_data = preprocess(params['stock'], relate_stocks)
